...
% Дата: 28.02.2021 
%-----------------------------------------------------------------
% 3*. (По ЕГЭ,2009,А8) Укажите с помощью языка Prolog, какое 
% логическое выражение равносильно выражению A&~(~BvC):
...
predicates
    ...
    third(bool, bool, bool, bool) % (3) A&B&~C (правильный вариант)
